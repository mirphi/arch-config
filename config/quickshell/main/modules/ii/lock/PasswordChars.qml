...
StyledFlickable {
    ...
    Behavior on contentX {
        animation: Appearance.animation.elementMoveEnter.createNumberAnimation(this)
    }
    ...
    Rectangle {
        ...
        Behavior on anchors.leftMargin {
            animation: Appearance.animation.elementMoveEnter.createNumberAnimation(cursor)
        }
    }
