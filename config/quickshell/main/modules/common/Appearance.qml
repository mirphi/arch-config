...
Singleton {
    id: root
    property AppearanceM3Colors m3colors: AppearanceM3Colors {}
    property AppearanceAnimation animation: AppearanceAnimation {}
    property AppearanceAnimationCurves animationCurves: AppearanceAnimationCurves {}
    property AppearanceColors colors: AppearanceColors {}
    property AppearanceRounding rounding: AppearanceRounding {}
    property AppearanceFont font: AppearanceFont {}
    property AppearanceSizes sizes: AppearanceSizes {}
    ...
    component AppearanceM3Colors: QtObject {
    ...
    component AppearanceColors: QtObject {
    ...
    component AppearanceRounding: QtObject {
    ...
    component AppearanceFont: QtObject {
        property AppearanceFontFamily family: AppearanceFontFamily {}
        property AppearanceFontVariableAxes variableAxes: AppearanceFontVariableAxes {}
        property AppearanceFontPixelSize pixelSize: AppearanceFontPixelSize {}
    }

    component AppearanceFontFamily: QtObject {
    ...
    component AppearanceFontVariableAxes: QtObject {
        property var main: ({
            "wght": 450,
            "wdth": 100,
        })
    ...
    component AppearanceFontPixelSize: QtObject {
    ...
    component AppearanceAnimationCurves: QtObject {
    ...
    component AppearanceAnimationSpec: QtObject {
        property int duration
        property int type
        property list<real> bezierCurve
        property int velocity
        property Component colorAnimation
        property Component numberAnimation

        function createColorAnimation(parent: QtObject, initialProperties): ColorAnimation {
            return colorAnimation.createObject(parent, initialProperties ?? ({})) as ColorAnimation
        }

        function createNumberAnimation(parent: QtObject, initialProperties): NumberAnimation {
            return numberAnimation.createObject(parent, initialProperties ?? ({})) as NumberAnimation
        }
    }

    component AppearanceAnimation: QtObject {
        property AppearanceAnimationSpec elementMove: AppearanceAnimationSpec {
            duration: animationCurves.expressiveDefaultSpatialDuration
            type: Easing.BezierSpline
            bezierCurve: animationCurves.expressiveDefaultSpatial
            velocity: 650
        ...
        property AppearanceAnimationSpec elementMoveSmall: AppearanceAnimationSpec {
            duration: animationCurves.expressiveFastSpatialDuration
            type: Easing.BezierSpline
            bezierCurve: animationCurves.expressiveFastSpatial
            velocity: 650
            numberAnimation: Component {
                NumberAnimation {
        ...
        property AppearanceAnimationSpec elementMoveEnter: AppearanceAnimationSpec {
            duration: 400
            type: Easing.BezierSpline
            bezierCurve: animationCurves.emphasizedDecel
            velocity: 650
            numberAnimation: Component {
                NumberAnimation {
                    alwaysRunToEnd: true
        ...
        property AppearanceAnimationSpec elementMoveExit: AppearanceAnimationSpec {
            duration: 200
            type: Easing.BezierSpline
            bezierCurve: animationCurves.emphasizedAccel
            velocity: 650
            numberAnimation: Component {
                NumberAnimation {
                    alwaysRunToEnd: true
        ...
        property AppearanceAnimationSpec elementMoveFast: AppearanceAnimationSpec {
            duration: animationCurves.expressiveEffectsDuration
            type: Easing.BezierSpline
            bezierCurve: animationCurves.expressiveEffects
            velocity: 850
            colorAnimation: Component { ColorAnimation {
                duration: root.animation.elementMoveFast.duration
                easing.type: root.animation.elementMoveFast.type
                easing.bezierCurve: root.animation.elementMoveFast.bezierCurve
            }}
            numberAnimation: Component { NumberAnimation {
                alwaysRunToEnd: true
                duration: root.animation.elementMoveFast.duration
                easing.type: root.animation.elementMoveFast.type
                easing.bezierCurve: root.animation.elementMoveFast.bezierCurve
        ...
        property AppearanceAnimationSpec elementResize: AppearanceAnimationSpec {
            duration: 300
            type: Easing.BezierSpline
            bezierCurve: animationCurves.emphasized
            velocity: 650
            numberAnimation: Component {
                NumberAnimation {
                    alwaysRunToEnd: true
        ...
        property AppearanceAnimationSpec clickBounce: AppearanceAnimationSpec {
            duration: 400
            type: Easing.BezierSpline
            bezierCurve: animationCurves.expressiveDefaultSpatial
            velocity: 850
        ...
        property AppearanceAnimationSpec scroll: AppearanceAnimationSpec {
            duration: 200
            type: Easing.BezierSpline
            bezierCurve: root.animationCurves.standardDecel
        }

        property AppearanceAnimationSpec menuDecel: AppearanceAnimationSpec {
            duration: 350
            type: Easing.OutExpo
        }
    }

    component AppearanceSizes: QtObject {
